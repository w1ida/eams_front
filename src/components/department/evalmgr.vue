    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <!--<el-form-item>
            <el-select v-model="filters.cosname" filterable placeholder="课程名" style="width: 200px;">
              <el-option
                v-for="item in cosnameoptions"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
          ...
          <el-form-item>
            <el-select v-model="filters.tname" filterable placeholder="任教老师" style="width: 120px;">
              <el-option
...
<script>
  import API from '../../api/api_evalmgr';
  export default {
    data() {
      return {
        filters: {
