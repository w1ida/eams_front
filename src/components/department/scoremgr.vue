  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>成绩核查</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          ...
          <el-form-item>
            <el-select clearable v-model="filters.tidname" filterable placeholder="姓名" style="width: 200px;" @change="handleSearch">
              <el-option
                v-for="item in tnameoptions"
                :label="item"
                :value="item">
              </el-option>
            </el-select>
      ...
      <el-table :data="users" highlight-current-row v-loading="loading" style="width: 100%;" >
       ...
       <!-- <el-table-column label="操作" width="70">
          <template slot-scope="scope">
            <el-button size="small" @click="saveScore(scope.$index,scope.row)">保存</el-button>
            &lt;!&ndash;<el-button type="danger" @click="delBook(scope.$index,scope.row)" size="small">删除</el-button>&ndash;&gt;
          </template>
        </el-table-column>-->
      </el-table>
    </el-col>
...
<script>
  import API from '../../api/api_scoresmgr';
  export default {
    data() {
      return {
        filters: {
